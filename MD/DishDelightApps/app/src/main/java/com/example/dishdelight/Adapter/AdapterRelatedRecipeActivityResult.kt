...
class AdapterRelatedRecipeActivityResult(private val listCategory: ArrayList<DataClassRelatedRecipeActivityResult>): RecyclerView.Adapter<AdapterRelatedRecipeActivityResult.ProgramViewHolder>() {
