package com.example.dishdelight.ui.result.listrelated
...
class AdapterRelatedFood(private val listCategory: ArrayList<RelatedFood>): RecyclerView.Adapter<AdapterRelatedFood.ProgramViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AdapterRelatedFood.ProgramViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_popular_food, parent, false)
        return ProgramViewHolder(view)
    }

    override fun onBindViewHolder(holder: AdapterRelatedFood.ProgramViewHolder, position: Int) {
