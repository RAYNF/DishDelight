...
class AdapterListIngredientsRecipeFragmentDashboard(private val listCategory: ArrayList<DataClassRecipeIngredientsFragmentDashboard>) :
    RecyclerView.Adapter<AdapterListIngredientsRecipeFragmentDashboard.ProgramViewHolder>() {
