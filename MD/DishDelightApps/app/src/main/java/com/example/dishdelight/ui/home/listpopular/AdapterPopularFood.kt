...
class AdapterPopularFood(private val listCategory: ArrayList<PopularFood>): RecyclerView.Adapter<AdapterPopularFood.ProgramViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): AdapterPopularFood.ProgramViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.item_popular_food, parent, false)
        return ProgramViewHolder(view)
    }

    override fun onBindViewHolder(holder: AdapterPopularFood.ProgramViewHolder, position: Int) {
